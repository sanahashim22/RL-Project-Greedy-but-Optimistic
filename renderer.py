...
def load_images():
    ...
    for names, images in dictionary_images.items():
        image_dictionary[names] = pygame.image.load(os.path.join("ludo_images", images)).convert()
...
def return_img_to_tile_pos(dice_img_list):
    tile_positions_list = [(329, 376), (376, 376), (423, 376), (470, 376), (517, 376), (564, 376), (611, 376)]
